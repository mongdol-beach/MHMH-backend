...
public record KakaoOAuth2Response(
    ...
    public record KakaoAccount(
        ...
        public record Profile(String nickname, String picture) {
            public static Profile from(Map<String, Object> attributes) {
                return new Profile(String.valueOf(attributes.get("nickname")), String.valueOf(attributes.get("picture")));
            }
        }
        ...
        public String picture() { return this.profile().picture(); }
    }
    ...
    public String picture() { return this.kakaoAccount().picture(); }
}